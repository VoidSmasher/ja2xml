...
class Markdown {
	...
	public static function instance($parser = NULL) {
		...
		if (!$config->offsetExists($parser)) {
			throw new Kohana_Exception('Failed to load Kohana Markdown parser: :parser', array(':parser' => $parser));
		}
	...
	public function __clone() {
		throw new Kohana_Exception('Cloning of Markdown objects is forbidden');
	}
