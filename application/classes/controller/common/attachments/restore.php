...
/**
 * Class: Controller_Common_Attachments_Restore
 * User: legion
 * Date: 26.09.19
 * Time: 18:20
 */
trait Controller_Common_Attachments_Restore {
	 ...
	 * @return string
	 */
	protected static function render_button_restore($item_index, $item_name, $attach_index, $attach_name, $ap_cost) {
	...
	protected function _restore(Core_Common $item_data_object) {
		$this->_restore_apply($item_data_object);
	...
	protected function _restore_apply(Core_Common $item_data_object) {
		if (!Form::is_post()) {
			return false;
		}
...
} // End Controller_Common_Attachments_Restore