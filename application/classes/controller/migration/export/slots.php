...
/**
 * Class: Controller_Migration_Export_Slots
 * User: legion
 * Date: 24.10.17
 * Time: 9:17
 */
class Controller_Migration_Export_Slots extends Controller_Migration_Template {

	protected $migration_title = 'Экспорт данных в AttachmentSlots.xml';

	const FILE_PATH = 'htdocs/uploads/Items/AttachmentSlots.xml';
...
<ATTACHMENTSLOTLIST>
			...
			$list = Core_Slot_Mod::factory()->get_list()->as_array();

			foreach ($list as $model) {
				$weapon = $xml->addChild('ATTACHMENTSLOT');
