...
/**
 * Class: Controller_Migration_Export_Incompatible
 * User: legion
 * Date: 24.10.17
 * Time: 9:17
 */
class Controller_Migration_Export_Incompatible extends Controller_Migration_Template {

	protected $migration_title = 'Экспорт данных в IncompatibleAttachments.xml';

	const FILE_PATH = 'htdocs/uploads/Items/IncompatibleAttachments.xml';
...
<INCOMPATIBLEATTACHMENTLIST>
			...
			$list = Core_Incompatible_Mod::factory()->get_list()->as_array();

			foreach ($list as $model) {
				$weapon = $xml->addChild('INCOMPATIBLEATTACHMENT');
...
} // End Controller_Migration_Export_Incompatible