...
/**
 * Class: Controller_Migration_Import_AttachmentsMod
 * User: legion
 * Date: 24.10.17
 * Time: 9:17
 */
class Controller_Migration_Import_AttachmentsMod extends Controller_Migration_Template {

	protected $migration_title = 'Импорт данных из 7609mod/Attachments.xml';
	protected $migration_description = [];

	const FILE_PATH = 'ja2/7609mod/items/Attachments.xml';
	...
	public function action_json_process() {
		...
		try {
			foreach ($xml->ATTACHMENT as $attachment) {
				$model = Core_Attachment_Mod::factory()->get_builder()
...
} // End Controller_Migration_Import_AttachmentsMod