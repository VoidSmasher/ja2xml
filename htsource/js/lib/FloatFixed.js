...
module.exports = MinimalClass.extend({
	...
	resize: function(){
		...
		this.top = window.app.scrollTop + rect.top;

		var parent_rect = this.element[0].parentNode.getBoundingClientRect();
		this.stop_at = window.app.scrollTop + parent_rect.top + parent_rect.height - this.offset;
	...
	scroll: function(scrollTop){
		...
		var should_be_fixed = scrollTop >= ( this.top - this.offset ),
